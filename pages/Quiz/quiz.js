const questions = [
  {
    ...
    image: "https://raw.githubusercontent.com/viniciuszile/Presente-minideca/main/Assets/miniargentino.jpg",
  ...
  },
  {
    ...
    image: "https://raw.githubusercontent.com/viniciuszile/Presente-minideca/main/Assets/miniparceiro.jpg",
    options: ["Cristian", "Rodrigão", "Vinizile", "Araujo"],
    answer: "Rodrigão",
  },
  {
    question: "Quem é melhor amiga do minideca ?",
    image: "https://raw.githubusercontent.com/viniciuszile/Presente-minideca/main/Assets/amiga.png",
    options: ["Jheny", "Sara Sarinha", "Rayane", "larissa"],
    answer: "Sara Sarinha",
  },
  {
    question: "Quem é o duo do amor do minideca?",
    image: "https://raw.githubusercontent.com/viniciuszile/Presente-minideca/main/Assets/duo.jpg  ",
    options: ["Vinizile", "Gabriel gol", "ViTiN", "Araujo"],
    answer: "Vinizile",
  },
  {
    question: "Qual a maior conquista do minideca?",
    image: "https://raw.githubusercontent.com/viniciuszile/Presente-minideca/main/Assets/mascara.png",
    options: [
      "Diamante",
      "amizade do vinizile",
      "ensino superior",
  ...
  },
  {
    ...
    image: "https://raw.githubusercontent.com/viniciuszile/Presente-minideca/main/Assets/sara.jpg",
    options: [
  ...
  },
  {
    ...
    image: "https://raw.githubusercontent.com/viniciuszile/Presente-minideca/main/Assets/minimic.jpg",
    options: [
      "Smokar",
      "Ser Toxico",
      "Vadiar / Vagabundar",
  ...
  },
  {
    ...
    image: "https://raw.githubusercontent.com/viniciuszile/Presente-minideca/main/Assets/carecadeca.jpg",
    options: [
  ...
  },
  {
    ...
    image: "https://raw.githubusercontent.com/viniciuszile/Presente-minideca/main/Assets/miniminideca.jpg",
    options: [
      "hollow knight",
      "The witcher",
      "Fortnite ft WS",
  ...
  },
  {
    ...
    image: "https://raw.githubusercontent.com/viniciuszile/Presente-minideca/main/Assets/cunhada.jpg",
